...
Thanks! atanisoft/esp_lcd_touch_xpt2046
...
* An ILI9341 LCD panel, with SPI interface (with/without XPT2046 SPI touch)
...
I (369) example: Turn off LCD backlight
I (369) gpio: GPIO[5]| InputEn: 0| OutputEn: 1| OpenDrain: 0| Pullup: 0| Pulldown: 0| Intr:0 
I (379) example: Initialize SPI bus
I (379) example: Install panel IO
I (389) gpio: GPIO[6]| InputEn: 0| OutputEn: 1| OpenDrain: 0| Pullup: 0| Pulldown: 0| Intr:0 
I (389) example: Install ILI9341 panel driver
I (399) gpio: GPIO[7]| InputEn: 0| OutputEn: 1| OpenDrain: 0| Pullup: 0| Pulldown: 0| Intr:0 
I (409) ili9341: LCD panel create success, version: 1.2.0
I (539) example: Initialize touch controller XPT2046
I (539) example: Turn on LCD backlight
I (539) example: Initialize LVGL library
I (539) example: Register display driver to LVGL
I (549) example: Install LVGL tick timer
I (549) example: Create LVGL task
I (549) example: Starting LVGL task
