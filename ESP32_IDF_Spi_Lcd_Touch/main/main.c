...
#include "esp_lcd_touch_xpt2046.h"
 ...
 || CONFIG_LV_USE_DEMO_KEYPAD_AND_ENCODER \
 || CONFIG_LV_USE_DEMO_BENCHMARK \
 || CONFIG_LV_USE_DEMO_STRESS \
 || CONFIG_LV_USE_DEMO_MUSIC
#include "lv_demos.h"
#endif

static const char *TAG = "example";

#define CONFIG_LV_USE_DEMO_CALENDAR (1)
...
#define EXAMPLE_PIN_NUM_TOUCH_IRQ      21
...
#define EXAMPLE_PIN_NUM_TOUCH_IRQ      3
...
#endif
#if CONFIG_LV_USE_DEMO_CALENDAR
...
//    ESP_LOGI(TAG, "example_lvgl_touch_cb %d, %d, %d, %d, %d", touchpad_pressed, touchpad_cnt, data->point.x, data->point.y, data->state);
}
#endif
